...
{
	Graph graph;
	int amountNodes, startVertex, endVertex, edgeWeight;
	...
	{
		cout << "Start node: "; cin >> startVertex; cout << endl;
		int* startVertPtr = &startVertex;
		cout << "End node: "; cin >> endVertex; cout << endl;
		int* endVertPtr = &endVertex;

		cout << "Ribbon's weight: "; cin >> edgeWeight; cout << endl;
		graph.InsertNode(*startVertPtr, *endVertPtr, edgeWeight);
	}
	cout << endl;
	return graph;
}
